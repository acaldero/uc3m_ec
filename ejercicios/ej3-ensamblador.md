...
1. ### <ins>Ensamblador I: nivel inicial</ins>
    ...
    **Ejemplo**: uso de las instrucciones aritméticas y lógicas.
    ...
    **Ejemplo**: traducción de bucles for/while.
    ...
    **Ejemplo**: traducción de bloques If-Then y If-Then-Else a ensamblador.
...
2. ### <ins>Ensamblador II: nivel medio</ins>  
    ...
    **Ejemplo**: dividir en sus partes (signo, exponente, mantisa) un valor IEEE754.
    ...
    **Ejemplo**: dado un vector de enteros, calcular la suma de sus elementos.
    ...
    **Ejemplo**: matriz: contar el número de elementos a cero en los valores enteros de una matriz</h5>
    ...
    **Ejemplo**: llamada a función: Factorial
...
3. ### <ins>Ensamblador III: nivel avanzado</ins>  
    ...
    **Ejemplo**: E/S dispositivo: Led matrix.
    ...
    **Ejemplo**: eventos de sistema: Floating point exception, system call, and an interrupt.
    ...
    **Ejemplo**: round-robin: Dos hilos en round-robin.
